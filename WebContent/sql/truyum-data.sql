...
-- b. 	Retrieving menu items (amdin view)
...
from
    truyum.menu_item
where
    me_active = 'Yes' and me_date_of_launch < (select CurDate());
...
set me_name = 'Cheesy Sandwich', me_price = 150.00, me_active = 'No', 
me_date_of_launch = '2018-03-15', me_category = 'Starters', me_free_delivery = 'No' 
where me_id = 1;
